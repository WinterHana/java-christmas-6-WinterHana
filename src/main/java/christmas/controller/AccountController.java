...
public class AccountController {
    public static Account makeAccount(String day, String menu) {
        ...
        DiscountGenerator discountGenerator
                = new DiscountGenerator(day, foodGenerator.countMain(), foodGenerator.countDessert());
        EventGenerator eventGenerator
                = new EventGenerator(foodGenerator.totalPrice()
                , discountGenerator.getTotalDiscountSum());
